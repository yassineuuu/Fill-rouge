        ...
        <section id='s2' class="projects">
            ...
            <div class="projects__list">
                <div class="projects__one">
                    ...
                    <div class="projects__one--title">
                        <h2><?php
                            echo $result['id'].'.'.$result['Title']
                            ?>
                            </h2>
                            <button class='edit' onclick='window.location.href="http://localhost/portfolio/views/Edit.php?id=<?php echo $result['id']?>"'>Edit</button>
                ...
                <div class="projects__two">
                    ...
                    <div class="projects__two--title2">
                            <h2><?php echo $result['id'].'.'.$result['Title'];?></h2>
                            <button class='edit' onclick='window.location.href="http://localhost/portfolio/views/Edit.php?id=<?php echo $result['id']?>"'>Edit</button>
                            <!-- <button class='delete'>Delete</button> -->
                    </div>
                ...
                <div class="projects__three">
                    ...
                    <div class="projects__three--title3">
                            <h2><?php echo $result['id'].'.'.$result['Title'];?></h2>
                            <button class='edit' onclick='window.location.href="http://localhost/portfolio/views/Edit.php?id=<?php echo $result['id']?>"'>Edit</button>
                            <!-- <button class='delete'>Delete</button> -->
                    </div>
                ...
                <div class="projects__four">
                    ...
                    <div class="projects__four--title4">
                            <h2><?php echo $result['id'].'.'.$result['Title'];?></h2>
                            <button class='edit' onclick='window.location.href="http://localhost/portfolio/views/Edit.php?id=<?php echo $result['id']?>"'>Edit</button>
                            <!-- <button class='delete'>Delete</button> -->
                    </div>
                ...
                <div class="projects__five">
                    ...
                    <div class="projects__five--title5">
                            <h2><?php echo $result['id'].'.'.$result['Title'];?></h2>
                            <button class='edit' onclick='window.location.href="http://localhost/portfolio/views/Edit.php?id=<?php echo $result['id']?>"'>Edit</button>
                            <!-- <button class='delete'>Delete</button> -->
                    </div>
